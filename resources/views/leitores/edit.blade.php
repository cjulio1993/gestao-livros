...
@section('content')
    <div class="max-w-3xl mx-auto">
        <x-dashboard-card title="Editar Leitor" color="blue"
            ...
            description="Preencha os detalhes do leitor para atualizá-lo no acervo.">
            <form method="POST" action="{{ route('leitores.update', $leitor) }}">
                @csrf
                @method('PUT')
                <div class="space-y-2">
                    ...
                    <div type="text" name="name" id="name"
                        ...
                        {{ old('name', ucwords($leitor->nome)) }} </div>
                    @error('name')
                ...
                <div class="space-y-2">
                    ...
                    <div type="text" name="cpf" id="cpf"
                        ...
                        placeholder="Digite o CPF do usuário"> {{ preg_replace('/(\d{3})(\d{3})(\d{3})(\d{2})/', '$1.$2.$3-$4', $leitor->cpf) }} </div>
                    @error('cpf')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div type="text" name="rg" id="rg"
                        ...
                        placeholder="Digite o RG do usuário"> {{ preg_replace('/(\d{2})(\d{3})(\d{3})(\d{1})/', '$1.$2.$3-$4', $leitor->rg) }} </div>
                    @error('rg')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div type="date" name="data_nascimento" id="data_nascimento"
                        ...
                        {{ old('data_nascimento', $leitor->data_nascimento->format('d/m/Y')) }}
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $leitor->telefone) }}"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        <input type="email" name="email" id="email" value="{{ old('email', $leitor->email) }}"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="endereco" id="endereco" value="{{ old('endereco', $leitor->endereco) }}"
